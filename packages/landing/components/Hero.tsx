          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              >
                ...
                Star on GitHub
                {/* shields.io static SVG — 1h cache, no JS, no API key.
                    Live count next to the action: small signal of life for
                    a Day 0–30 bootstrap network. */}
                <img
                  alt="GitHub stars"
                  src="https://img.shields.io/github/stars/Swarmwage/swarmwage?style=flat-square&label=&color=8b6fe8&labelColor=transparent"
                  height="16"
